...
namespace aMuse.Core.Library
{
    public class AudioFile
    {
        ...
        public AudioFile(string path)
        {
            ...
            if (file.Tag.AlbumArtists.Length > 0 && !String.IsNullOrWhiteSpace(file.Tag.AlbumArtists[0]))
            {
...
{"q", Artist + " " + Track},
        ...
        private string/*async Task<string>*/ GetLyrics()
        {
        ...
        private List<byte[]> GetAlbumCovers()
        {
